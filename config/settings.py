...
DEFAULT_FROM_EMAIL = "KincaidLogs <no-reply@kincaidlogs.com>"


AUTH_USER_MODEL = "accounts.User"
TRANSACTPAY_SECRET_KEY = os.getenv("TRANSACTPAY_SECRET_KEY", "")
TRANSACTPAY_PUBLIC_KEY = os.getenv("TRANSACTPAY_PUBLIC_KEY", "")
TRANSACTPAY_ENCRYPTION_KEY = os.getenv("TRANSACTPAY_ENCRYPTION_KEY", "")
TRANSACTPAY_WEBHOOK_SECRET = os.getenv("TRANSACTPAY_WEBHOOK_SECRET", "")
TRANSACTPAY_CURRENCY = "NGN"
